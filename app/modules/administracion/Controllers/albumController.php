<?php
/**
* Controlador de Album que permite la  creacion, edicion  y eliminacion de los álbum del Sistema
*/
class Administracion_albumController extends Administracion_mainController
{
	...
	/**
	 * $mainModel  instancia del modelo de  base de datos álbum
	...
	/**
     * Recibe la informacion y  muestra un listado de  álbum con sus respectivos filtros.
     *
     * @return void.
     */
	public function indexAction()
	{
		$title = "Administración de álbum";
	...
	/**
     * Genera la Informacion necesaria para editar o crear un  álbum  y muestra su formulario
     *
     * @return void.
     */
	...
	/**
     * Inserta la informacion de un álbum  y redirecciona al listado de álbum.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un álbum  y redirecciona al listado de álbum.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un álbum  y redirecciona al listado de álbum.
     *
     * @return void.
     */
    ...
    protected function getFilter()
    {
        ...
        if (Session::getInstance()->get($this->namefilter)!="") {
            ...
            if ($filters->album_estado != '') {
                $filtros = $filtros." AND album_estado LIKE '%".$filters->album_estado."%'";
            }
		}
        return $filtros;
    }
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['album_estado'] =  $this->_getSanitizedParam("album_estado");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
