<?php
/**
* Controlador de Categoria que permite la  creacion, edicion  y eliminacion de los categor&iacute;as del Sistema
*/
class Administracion_categoriaController extends Administracion_mainController
{
	public $botonpanel = 5;
	 ...
	 * @var string
	 */
	protected $_csrf_section = "administracion_categoria";
	...
	/**
     * Inicializa las variables principales del controlador categoria .
     *
     * @return void.
     */
	public function init()
	{
		$this->mainModel = new Administracion_Model_DbTable_Categoria();
		$this->namefilter = "parametersfiltercategoria";
		$this->route = "/administracion/categoria";
		$this->namepages ="pages_categoria";
		$this->namepageactual ="page_actual_categoria";
	...
	{
		$this->_view->route = $this->route;
		$this->_csrf_section = "manage_categoria_".date("YmdHis");
	...
	/**
     * Recibe la informacion del formulario y la retorna en forma de array para la edicion y creacion de Categoria.
     *
