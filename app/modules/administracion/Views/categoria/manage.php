		...
		<div class="col-2 form-group">
			...
			<br>
				...
				<div class="col-5 form-group">
					...
					<input type="file" name="categoria_imagen" id="categoria_imagen" class="form-control  file-image" data-buttonName="btn-primary" accept="image/gif, image/jpg, image/jpeg, image/png"  <?php if(!$this->content->categoria_id){ echo 'required'; } ?>>
					<div class="help-block with-errors"></div>
