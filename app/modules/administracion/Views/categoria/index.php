        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="categoria_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="categoria_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->categoria_id; ?>
					<tr>
						<td><?=$content->categoria_nombre;?></td>
						<td>
							<?php if($content->categoria_imagen) { ?>
								<img src="/images/<?= $content->categoria_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->categoria_imagen; ?></div>
						</td>
						<td>
						...
						<td class="text-right">
							<div>
							<a class="btn btn-rosado btn-sm" href="/administracion/convenios/?categoria=<?= $id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Convenios"><i class="fas fa-plus"></i></a>
