				...
				<div class="col-6 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?php if ($this->content->album_fecha) {
														...
														echo date('Y-m-d');
													} ?>" name="album_fecha" id="album_fecha" class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="es">
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-6 form-group">
					<label for="album_imagen">imagen</label>
					<input type="file" name="album_imagen" id="album_imagen" class="form-control  file-image" data-buttonName="btn-primary" accept="image/gif, image/jpg, image/jpeg, image/png" required>
					<div class="help-block with-errors"></div>
