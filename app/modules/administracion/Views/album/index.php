        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="album_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'album_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                <label>fecha</label>
	                ...
	                <input type="text" class="form-control" name="album_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'album_fecha') ?>"></input>
	                    </label>
	            </div>
				<div class="col-3">
		            <label>imagen</label>
		            ...
		            <input type="text" class="form-control" name="album_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'album_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="album_estado" value="<?php echo $this->getObjectVariable($this->filters, 'album_estado') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->album_id; ?>
					<tr>
						<td><?=$content->album_nombre;?></td>
						...
						<td class="text-right">
							<div>
								...
								<a class="btn btn-rosado btn-sm" href="/administracion/fotos/?album=<?= $id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Imágenes"><i class="fas fa-images"></i></a>
