        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="fotos_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'fotos_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>foto</label>
		            ...
		            <input type="text" class="form-control" name="fotos_foto" value="<?php echo $this->getObjectVariable($this->filters, 'fotos_foto') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>fotos_album</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-verde " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="fotos_album" value="<?php echo $this->getObjectVariable($this->filters, 'fotos_album') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
    ...
    <div align="center">
	    ...
	    <?php
	        ...
	        if ($this->totalpages > 1) {
	            if ($this->page != 1)
	                echo '<li class="page-item" ><a class="page-link"  href="'.$url.'?page='.($this->page-1).'&album='.$this->album.'"> &laquo; Anterior </a></li>';
	            ...
	            if ($this->page != $this->totalpages)
	                echo '<li class="page-item"><a class="page-link" href="'.$url.'?page='.($this->page+1).'&album='.$this->album.'">Siguiente &raquo;</a></li>';
	        }
	  	?>
	  	</ul>
	</div>
	<div class="content-dashboard">
	    <div class="franja-paginas">
		    <div class="row">
		    	...
		    	<div class="col-3">
		    		<div class="text-right"><a class="btn btn-sm btn-success" href="<?php echo $this->route."\manage"."?album=".$this->album.""; ?>"> <i class="fas fa-plus-square"></i> Crear Nuevo</a></div>
		    	</div>
		    </div>
	    </div>
							  	...
							  	<div class="modal-dialog" role="document">
							    	<div class="modal-content">
								      ...
								      <div class="modal-footer">
								        	...
								        	<a class="btn btn-danger" href="<?php echo $this->route;?>/delete?id=<?= $id ?>&csrf=<?= $this->csrf;?><?php echo ''.'&album='.$this->album; ?>" >Eliminar</a>
								      </div>
							    	</div>
							  	</div>
							</div>
