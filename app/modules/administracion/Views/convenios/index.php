        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="convenio_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'convenio_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="convenio_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'convenio_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
	    <div class="franja-paginas">
		    <div class="row">
		    	...
		    	<div class="col-3">
		    		<div class="text-right"><a class="btn btn-sm btn-success" href="<?php echo $this->route."\manage"."?categoria=".$this->categoria.""; ?>"> <i class="fas fa-plus-square"></i> Crear Nuevo</a></div>
		    	</div>
		    </div>
	    </div>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->convenio_id; ?>
					<tr>
						<td><?=$content->convenio_nombre;?></td>
						<td>
							<?php if($content->convenio_imagen) { ?>
								<img src="/images/<?= $content->convenio_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->convenio_imagen; ?></div>
						</td>
						<td>
							  	...
							  	<div class="modal-dialog" role="document">
							    	<div class="modal-content">
									  ...
									  <button type="button" class="btn btn-default" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
								        	<a class="btn btn-danger" href="<?php echo $this->route;?>/delete?id=<?= $id ?>&csrf=<?= $this->csrf;?><?php echo ''.'&categoria='.$this->categoria; ?>" >Eliminar</a>
								      </div>
							    	</div>
							  	</div>
							</div>
