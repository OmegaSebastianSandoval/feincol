...
<div class="container pb-5 animado">
  <h2>
    Felicitaciones o sugerencias</h2>
  <div class="row d-flex flex-column align-items-center">
    <div class="col-12 col-lg-9">
      <form action="/page/felicitaciones/envarmensaje" class="formulario-contacto" id="formulario-contacto">
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="col-12">
              ...
              <div class="col-12 col-md-6">
                <input type="text" id="empresa" name="empresa" class="input-field" placeholder="Nombre empresa*" required>
              </div>
              <div class="col-12">
