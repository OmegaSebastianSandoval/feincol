<div class="docs-container docs-container-<?php echo $contenedor->contenido_id; ?> <?php echo $contenedor->contenido_columna; ?> my-4 <?php if ($contenedor->contenido_caja == 1) {
                                                                                                                                        echo 'caja-tipografica';
                                                                                                                                      } ?>" style="<?php if ($contenedor->contenido_top) {
                                                                                                                                                      echo ' padding-top:' . $contenedor->contenido_top . 'px; ';
                                                                                                                                                    } ?><?php if ($contenedor->contenido_bottom) {
                                                                                                                                                          echo ' padding-bottom: ' . $contenedor->contenido_bottom . 'px; ';
                                                                                                                                                        } ?><?php if ($contenedor->contenido_left) {
                                                                                                                                                              echo ' padding-left:' . $contenedor->contenido_left . 'px; ';
                                                                                                                                                            } ?><?php if ($contenedor->contenido_right) {
                                                                                                                                                                  echo ' padding-right:' . $contenedor->contenido_right . 'px; ';
                                                                                                                                                                } ?>">
  <div class="row mx-0">
    ...
    <div class="col-12 docs-body">
      <?php if ($contenedor->contenido_descripcion) { ?>

        <div class="docs-descripcion"><?php echo $contenedor->contenido_descripcion; ?></div>
      <?php } ?>
      <div class="row items-docs-row">
        <?php foreach ($rescontenido['hijos'] as $hijos) { ?>
                ...
                <div class="col-12 doc-item-theme prueba" data-id="docs-<?php echo $docs->contenido_id; ?>" style="background: <?php echo $docs->contenido_fondo_color; ?>;">
                  <div class="row d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-3 d-flex justify-content-end align-items-center">
                      <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $docs->contenido_id ?>"></i>
                    </div>
                  </div>
                </div>
                    ...
                    <?php foreach ($hijos['hijos'] as $ddoc2) { ?>
                        ...
                        <div class="d-flex w-100 flex-column">
                          <div class="col-12 doc-item-theme my-2" data-id="docs-<?php echo $d->contenido_id; ?>" style="background: <?php echo $d->contenido_fondo_color; ?>;">
                            <div class="row d-flex justify-content-center align-items-center">
                              ...
                              <div class="col-3 d-flex justify-content-end align-items-center">
                                <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $d->contenido_id ?>"></i>
                              </div>
                            </div>
                          </div>
                                  ...
                                  <div class="d-flex w-100 flex-column">
                                    <div class="col-12 doc-item-theme my-2 prueba" data-id="docs-<?php echo $r->contenido_id; ?>" style="background: <?php echo $r->contenido_fondo_color; ?>;">
                                      <div class="row d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="col-3 d-flex justify-content-end align-items-center">
                                          <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $r->contenido_id ?>"></i>
                                        </div>
                                      </div>
                                    </div>
                                                ...
                                                <div class="d-flex w-100 flex-column">
                                                  <div class="col-12 doc-item-theme my-2 prueba" data-id="docs-<?php echo $r1->contenido_id; ?>" style="background: <?php echo $r1->contenido_fondo_color; ?>;">
                                                    <div class="row d-flex justify-content-center align-items-center">
                                                      ...
                                                      <div class="col-3 d-flex justify-content-end align-items-center">
                                                        <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $r1->contenido_id ?>"></i>
                                                      </div>
                                                    </div>
                                                  </div>
                                                      ...
                                                      <?php foreach ($this->contenidos['hijos_' . $r1->contenido_id] as $bis3) { ?>
                                                        <?php if ($bis3->contenido_id > 0) { ?>
                                                            ...
                                                            <div class="d-flex w-100 flex-column">
                                                              <div class="col-12 doc-item-theme my-2 prueba" data-id="docs-<?php echo $bis3->contenido_id; ?>" style="background: <?php echo $bis3->contenido_fondo_color; ?>;">
                                                                <div class="row d-flex justify-content-center align-items-center">
                                                                  ...
                                                                  <div class="col-3 d-flex justify-content-end align-items-center">
                                                                    <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $bis3->contenido_id ?>"></i>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                                          ...
                                                                          <?php if ($bis4->contenido_id > 0 and $bis4->contenido_padre == $padre5) { ?>
                                                                            ...
                                                                            <?php if ($bis4->contenido_archivo) { ?>
                                                                              <div class="col-12 doc">
                                                                                <a href="/files/<?php echo $bis4->contenido_archivo ?>" target="_blank">
                                                                              ...
                                                                              <div class="d-flex w-100 flex-column">
                                                                                <div class="col-12 doc-item-theme my-2 prueba" data-id="docs-<?php echo $bis4->contenido_id; ?>" style="background: <?php echo $bis4->contenido_fondo_color; ?>;">
                                                                                  <div class="row d-flex justify-content-center align-items-center">
                                                                                    ...
                                                                                    <div class="col-3 d-flex justify-content-end align-items-center">
                                                                                      <i class="fa-solid fa-circle-arrow-down" data-icon="icon-<?php echo $bis4->contenido_id ?>"></i>
                                                                                    </div>
                                                                                  </div>
                                                                                </div>
                                                                                  ...
                                                                                  <div class="row docs">
                                                                                    <?php foreach ($this->contenidos['hijos_' . $padre6] as $bis5) { ?>
                                                                                      <?php if ($bis5->contenido_archivo) { ?>
                                                                                        <div class="col-12 doc">
                                                                                          <a href="/files/<?php echo $bis5->contenido_archivo ?>" target="_blank">
                                                                                            <div class="row d-flex justify-content-start align-items-center">
                                                                                              <div class="col-10">
                                                          ...
                                                          <?php if (!$bis3->contenido_icono) { ?>
                                                            ...
                                                            <?php if ($bis3->contenido_id > 0) { ?>
                                                              <div class="col-12 doc">
                                                                <a href="/files/<?php echo $bis3->contenido_archivo ?>" target="_blank">
                                                                  <div class="row d-flex justify-content-start align-items-center">
                                                                    <div class="col-10">
                                                            ...
                                                            <div class="col-12 doc" style="border-radius: 0 0 10px 10px;">
                                                              <a href="/files/<?php echo $bis3->contenido_archivo ?>" target="_blank">
                                                                <div class="row d-flex justify-content-end align-items-center">
                                                                  ...
                                                                  <?php } ?>
                                                                  <div class="col-11">
                                                                    <h5><?php echo $bis3->contenido_titulo; ?></h5>
                                                                  </div>
                                                                </div>
                                                              </a>
                                                            </div>
                                                  ...
                                                  <div class="col-12 doc" style="border-radius: 0 0 10px 10px;">
                                                    <a href="/files/<?php echo $r1->contenido_archivo ?>" target="_blank">
                                                      <div class="row d-flex justify-content-end align-items-center">
                                                        ...
                                                        <?php } ?>
                                                        <div class="col-11">
                                                          <h5 style=""><?php echo $r1->contenido_titulo; ?></h5>
                                                        </div>
                                                      </div>
                                                    </a>
                                                  </div>
                                  ...
                                  <?php if (!$r->contenido_icono) { ?>
                                    <div class="col-12 doc">
                                      <div class="row d-flex justify-content-start align-items-center">
                                        ...
                                        <?php if ($r->contenido_archivo) { ?>
                                          <div class="col-2 d-flex justify-content-end">
                                            <a href="/files/<?php echo $r->contenido_archivo ?>" target="_blank"><i class="fa-solid fa-file-pdf"></i></a>
                                          </div>
                                        <?php } ?>
                                      </div>
                                    </div>
                      ...
                      <?php } else { ?>
                        <?php if (!$d->contenido_icono) { ?>
                          <div class="col-12 doc">
                            <a href="/files/<?php echo $d->contenido_archivo ?>" target="_blank">
                              <div class="row d-flex justify-content-start align-items-center">
                                <div class="col-10">
                          ...
                          <div class="col-12 doc" style="border-radius: 0 0 10px 10px;">
                            <a href="/files/<?php echo $d->contenido_archivo ?>" target="_blank">
                              <div class="row d-flex justify-content-end align-items-center">
                                <?php if ($d->contenido_archivo) { ?>
                                  <div class="col-1 d-flex justify-content-end">
                                    <img class="img-docs ms-auto" src="/images/<?php echo $d->contenido_icono ?>" alt="" style="width: 70px;">
                                  </div>
                                <?php } ?>
                                <div class="col-11">
          ...
          <?php } else { ?>
            <a target="_blank" href="/files/<?php echo $docs->contenido_archivo; ?>" class="d-flex w-100">
